      ...
      <div className="flex flex-wrap lg:flex-nowrap justify-center ">
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 ">
          ...
          <div className='justify-between items-center'>
            <div>
              <p className='font-bold'>Rendimentos</p>
              <p className='text-2xl'>R$63,448</p>
            </div>
          </div>
          <div className="mt-6">
            <Button
      ...
      <div className='flex gap-10 flex-wrap justify-center'>
            <div className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780'>
              <div className='flex justify-between'>
                <p className='font-semibold text-xl'>Atualização de Receita</p>
              ...
              <div className='mt-10 flex gap-10 flex-wrap justify-center'>
                <div className='border-r-1 border-color m-4 pr-10'>
                  ...
                  <div className='mt-8'>
                    <p>
                      <span className='text-3xl font-semibold'>RS48,438</span>
